    ...
    return (
        <div className="sidebar">
            ...
            <div className="sidebar-content">
                ...
                {error && (
                    <div className="mt-4 text-accent-red text-sm p-3 bg-red-50 rounded-lg border border-red-200">
                ...
                {cityData && (
                    <div className="mt-8">
                        <h2 className="text-base font-semibold mb-4 border-b border-border-subtle pb-2 text-text-primary">Twin Status</h2>
                        <div className="grid grid-cols-2 gap-3">
                            <div className="status-card h-auto m-0">
                                <h3>Nodes</h3>
                        ...
                        <p className="mt-4 text-[0.75rem] text-text-secondary">
