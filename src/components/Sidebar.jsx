...
//                             {/* CATEGORIZED SIMULATION CONTROLS */}
//                             <div className="space-y-6 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">

//                                 {/* 1. Weather & Earth */}
//                                 <div>
//                                     <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3 border-b border-slate-100 pb-1">Weather & Earth</h3>
...
//                                             </label>
//                                             <input type="range" min="0" max="1" step="0.05" value={areaParams.rainfall} onChange={(e) => setAreaParams({ ...areaParams, rainfall: parseFloat(e.target.value) })} className="w-full accent-[#1B899D]" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Wind Speed <span>{areaParams.windSpeed} km/h</span>
//                                             </label>
//                                             <input type="range" min="0" max="150" step="5" value={areaParams.windSpeed} onChange={(e) => setAreaParams({ ...areaParams, windSpeed: parseInt(e.target.value) })} className="w-full accent-[#1B899D]" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Temperature <span>{areaParams.temperature}°C</span>
//                                             </label>
//                                             <input type="range" min="-20" max="50" step="1" value={areaParams.temperature} onChange={(e) => setAreaParams({ ...areaParams, temperature: parseInt(e.target.value) })} className="w-full accent-[#1B899D]" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Fog / Visibility <span>{(areaParams.fog * 100).toFixed(0)}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="1" step="0.05" value={areaParams.fog} onChange={(e) => setAreaParams({ ...areaParams, fog: parseFloat(e.target.value) })} className="w-full accent-[#1B899D]" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Earthquake (Richter) <span>{areaParams.earthquake.toFixed(1)}</span>
//                                             </label>
//                                             <input type="range" min="0" max="9" step="0.1" value={areaParams.earthquake} onChange={(e) => setAreaParams({ ...areaParams, earthquake: parseFloat(e.target.value) })} className="w-full accent-red-500" />
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                 {/* 2. Transport & Traffic */}
//                                 <div>
//                                     <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3 border-b border-slate-100 pb-1">Transport & Traffic</h3>
//                                     <div className="space-y-4">
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Traffic Density <span>{(areaParams.trafficDensity * 100).toFixed(0)}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="1" step="0.05" value={areaParams.trafficDensity} onChange={(e) => setAreaParams({ ...areaParams, trafficDensity: parseFloat(e.target.value) })} className="w-full accent-[#55A2B2]" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Accident Rate <span>{(areaParams.accidentRate * 100).toFixed(0)}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="1" step="0.05" value={areaParams.accidentRate} onChange={(e) => setAreaParams({ ...areaParams, accidentRate: parseFloat(e.target.value) })} className="w-full accent-[#55A2B2]" />
//                                         </div>
//                                         <div className="flex flex-wrap gap-2 pt-1">
//                                             <label className="flex items-center gap-2 text-[11px] font-medium p-2 bg-slate-50 border border-slate-200 rounded-lg cursor-pointer hover:bg-slate-100 transition truncate">
//                                                 <input type="checkbox" checked={areaParams.roadClosure} onChange={(e) => setAreaParams({ ...areaParams, roadClosure: e.target.checked })} className="accent-[#1B899D]" />
//                                                 Road Closures
//                                             </label>
//                                             <label className="flex items-center gap-2 text-[11px] font-medium p-2 bg-slate-50 border border-slate-200 rounded-lg cursor-pointer hover:bg-slate-100 transition truncate">
//                                                 <input type="checkbox" checked={areaParams.publicTransportFailure} onChange={(e) => setAreaParams({ ...areaParams, publicTransportFailure: e.target.checked })} className="accent-[#1B899D]" />
//                                                 Transit Failure
//                                             </label>
//                                         </div>
//                                     </div>
...
//                                 <div>
//                                     <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3 border-b border-slate-100 pb-1">Infrastructure & Grid</h3>
//                                     <div className="space-y-4">
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Power Grid Load <span>{areaParams.powerGridLoad}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="150" step="5" value={areaParams.powerGridLoad} onChange={(e) => setAreaParams({ ...areaParams, powerGridLoad: parseInt(e.target.value) })} className="w-full accent-amber-500" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Water Pressure <span>{areaParams.waterPressure}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="100" step="5" value={areaParams.waterPressure} onChange={(e) => setAreaParams({ ...areaParams, waterPressure: parseInt(e.target.value) })} className="w-full accent-blue-400" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Comms Congestion <span>{(areaParams.cellTowerCongestion * 100).toFixed(0)}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="1" step="0.05" value={areaParams.cellTowerCongestion} onChange={(e) => setAreaParams({ ...areaParams, cellTowerCongestion: parseFloat(e.target.value) })} className="w-full accent-purple-500" />
//                                         </div>
//                                         <label className="flex items-center gap-2 text-[11px] font-medium p-2 bg-slate-50 border border-slate-200 rounded-lg cursor-pointer hover:bg-slate-100 transition">
//                                             <input type="checkbox" checked={areaParams.powerOutage} onChange={(e) => setAreaParams({ ...areaParams, powerOutage: e.target.checked })} className="accent-amber-500" />
//                                             Active Blackout
//                                         </label>
//                                     </div>
//                                 </div>
...
//                                 {/* 4. Population & Public */}
//                                 <div>
//                                     <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3 border-b border-slate-100 pb-1">Population & Public</h3>
//                                     <div className="space-y-4">
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Crowd Density <span>{(areaParams.crowdDensity * 100).toFixed(0)}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="1" step="0.05" value={areaParams.crowdDensity} onChange={(e) => setAreaParams({ ...areaParams, crowdDensity: parseFloat(e.target.value) })} className="w-full accent-indigo-500" />
//                                         </div>
//                                         <div className="flex flex-wrap gap-2">
//                                             <label className="flex items-center gap-2 text-[11px] font-medium p-2 bg-slate-50 border border-slate-200 rounded-lg cursor-pointer hover:bg-slate-100 transition truncate">
//                                                 <input type="checkbox" checked={areaParams.publicEvent} onChange={(e) => setAreaParams({ ...areaParams, publicEvent: e.target.checked })} className="accent-indigo-500" />
//                                                 Public Event
//                                             </label>
//                                             <label className="flex items-center gap-2 text-[11px] font-medium p-2 bg-red-50 border border-red-200 text-red-700 rounded-lg cursor-pointer hover:bg-red-100 transition truncate">
//                                                 <input type="checkbox" checked={areaParams.evacuationOrder} onChange={(e) => setAreaParams({ ...areaParams, evacuationOrder: e.target.checked })} className="accent-red-600" />
//                                                 Evacuation Order
//                                             </label>
//                                         </div>
//                                     </div>
...
//                                 {/* 5. Crisis Scenarios */}
//                                 <div>
//                                     <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-3 border-b border-slate-100 pb-1">Crisis Scenarios</h3>
//                                     <div className="space-y-4">
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Fire Risk Index <span>{(areaParams.fireRisk * 100).toFixed(0)}%</span>
//                                             </label>
//                                             <input type="range" min="0" max="1" step="0.05" value={areaParams.fireRisk} onChange={(e) => setAreaParams({ ...areaParams, fireRisk: parseFloat(e.target.value) })} className="w-full accent-orange-500" />
//                                         </div>
//                                         <div className="simulation-control">
//                                             <label className="text-xs flex justify-between text-slate-600 mb-1">
//                                                 Air Quality (AQI) <span>{areaParams.airQuality}</span>
//                                             </label>
//                                             <input type="range" min="0" max="500" step="10" value={areaParams.airQuality} onChange={(e) => setAreaParams({ ...areaParams, airQuality: parseInt(e.target.value) })} className="w-full accent-emerald-500" />
//                                         </div>
//                                         <label className="flex items-center gap-2 text-[11px] font-medium p-2 bg-slate-50 border border-slate-200 rounded-lg cursor-pointer hover:bg-slate-100 transition">
//                                             <input type="checkbox" checked={areaParams.chemicalSpill} onChange={(e) => setAreaParams({ ...areaParams, chemicalSpill: e.target.checked })} className="accent-orange-500" />
        ...
        <>
            ...
            {selectedAlertForPlan && (
                <ActionPlanModal
                    alert={selectedAlertForPlan}
                    cityData={cityData}
                    cityName={cityNameProp || cityData?.name || ''}
                    sensorData={sensorData}
                    elevationSamples={elevationSamples}
                    onClose={() => setSelectedAlertForPlan(null)}
                />
